...
struct  _Mgmt__JoinReq
{
  ...
  uint32_t rank;
  /*
   * Server CaRT base URIs (i.e., for context 0).
   */
  size_t n_uris;
  char **uris;
  /*
...
#define MGMT__JOIN_REQ__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&mgmt__join_req__descriptor) \
    , (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0, 0,NULL, 0, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0, 0 }
...
struct  _Mgmt__GetAttachInfoResp
{
   ...
   */
  size_t n_additional_rank_uris;
  Mgmt__GetAttachInfoResp__RankUri **additional_rank_uris;
  /*
   * Hints for additional providers
   */
  size_t n_additional_client_net_hints;
  Mgmt__ClientNetHint **additional_client_net_hints;
};
