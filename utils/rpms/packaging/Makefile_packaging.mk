  ...
  ifneq ($(REPOSITORY_URL),)
    ...
    ifneq ($(DAOS_STACK_$(DISTRO_BASE)_$(DAOS_REPO_TYPE)_REPO),)
      ifeq ($(ID_LIKE),debian)
        ...
        $(DISTRO_BASE)_LOCAL_REPOS := $(subst repository/,artifactory/,$(subst leap,sl,$(REPOSITORY_URL)$(subst daos-stack-,daos-stack-daos-,$(DAOS_STACK_$(DISTRO_BASE)_LOCAL_REPO))|$(REPOSITORY_URL)$(subst daos-stack-,daos-stack-deps-,$(DAOS_STACK_$(DISTRO_BASE)_LOCAL_REPO))))
      ...
      ifeq ($(DISTRO_BASE), EL_8)
        ...
        $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(subst $(ORIG_TARGET_VER),$(DISTRO_VERSION),$(REPOSITORY_URL)artifactory/rocky-8.5-base-x86_64-proxy|$(REPOSITORY_URL)artifactory/rocky-8.5-extras-x86_64-proxy|$(REPOSITORY_URL)artifactory/epel-el-8-x86_64-proxy)
      else ifeq ($(DISTRO_BASE), EL_7)
        # hack to use 7.9 non-group repos on EL_7
        $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(subst $(ORIG_TARGET_VER),$(DISTRO_VERSION),$(REPOSITORY_URL)artifactory/centos-7.9.2009-base-x86_64-proxy|$(REPOSITORY_URL)artifactory/centos-7.9.2009-extras-x86_64-proxy|$(REPOSITORY_URL)artifactory/centos-7.9.2009-updates-x86_64-proxy|$(REPOSITORY_URL)artifactory/epel-el-7-x86_64-proxy)
      else ifeq ($(DISTRO_BASE), LEAP_15)
        # hack to use 15 non-group repos on LEAP_15
        $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(subst $(ORIG_TARGET_VER),$(DISTRO_VERSION),$(REPOSITORY_URL)artifactory/opensuse-15.2-oss-x86_64-proxy|$(REPOSITORY_URL)artifactory/opensuse-15.2-update-oss-x86_64-proxy|$(REPOSITORY_URL)artifactory/opensuse-15.2-update-non-oss-x86_64-proxy|$(REPOSITORY_URL)artifactory/opensuse-15.2-non-oss-x86_64-proxy|$(REPOSITORY_URL)artifactory/opensuse-15.2-repo-sle-update-proxy|$(REPOSITORY_URL)artifactory/opensuse-15.2-repo-backports-update-proxy)
      else
        # debian
    ...
    ifneq ($(DAOS_STACK_$(DISTRO_BASE)_APPSTREAM_REPO),)
      $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(REPOSITORY_URL)$(subst repository/,artifactory/,$(subst centos-8.3,rocky-8.5,$(DAOS_STACK_$(DISTRO_BASE)_APPSTREAM_REPO)))
    endif
    ...
    ifneq ($(DAOS_STACK_$(DISTRO_BASE)_POWERTOOLS_REPO),)
      $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(REPOSITORY_URL)$(subst repository/,artifactory/,$(subst centos-8.3,rocky-8.5,$(DAOS_STACK_$(DISTRO_BASE)_POWERTOOLS_REPO)))
    endif
    ifneq ($(ID_LIKE),debian)
